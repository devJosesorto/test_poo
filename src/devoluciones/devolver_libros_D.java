...
public class devolver_libros_D extends javax.swing.JFrame {

    conexion.Conexion con = new conexion.Conexion();
    Connection cnn = con.conexion();
    
   
    public devolver_libros_D() {
        initComponents();
        mostrardatos("");
    ...
    private void TablaLibrosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaLibrosMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            Menu_devolucion_D.txtCod_material.setText(cod);
            Menu_devolucion_D.txtTitulo.setText(valor);
            Menu_devolucion_D.txtisbn.setText(isbn);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(devolver_libros_D.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new devolver_libros_D().setVisible(true);
            }
        });
    }
