...
public class ver_libros_devolver extends javax.swing.JFrame {

    conexion.Conexion con = new conexion.Conexion();
    Connection cnn = con.conexion();
    
   
    public ver_libros_devolver() {
        initComponents();
        mostrardatos("");
    ...
    private void TablaLibrosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaLibrosMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            Menu_devolucion_E.txtCod_material.setText(cod);
            Menu_devolucion_E.txtTitulo.setText(valor);
            Menu_devolucion_E.txtisbn.setText(isbn);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_libros_devolver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_libros_devolver().setVisible(true);
            }
        });
    }
