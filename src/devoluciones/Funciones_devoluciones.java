 ...
 * @author Bolaines
 */
public class Funciones_devoluciones {
    ...
    public Funciones_devoluciones() {
    
}

    public Funciones_devoluciones(int recibo_E, String carnet, String cod_libro, int cantidad, Date fecha_prestamo, Date fecha_devolucion) {
