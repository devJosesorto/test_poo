...
public class ver_estudiantes2 extends javax.swing.JFrame {

     Conexion con = new Conexion();
    Connection cnn = con.conexion();
    
    public ver_estudiantes2() {
        initComponents();
        mostrarRegistros("");
    ...
    private void TablaEstudiantesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaEstudiantesMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            Menu_pretamos_E2.txtCarnet.setText(cod);
            Menu_pretamos_E2.txtEstudiante.setText(valor);
            Menu_pretamos_E2.txtgrado.setText(grado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_estudiantes2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_estudiantes2().setVisible(true);
            }
        });
    }
