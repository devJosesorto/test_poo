...
public class ver_docentes2 extends javax.swing.JFrame {

     Conexion con = new Conexion();
    Connection cnn = con.conexion();
    
    public ver_docentes2() {
        initComponents();
        mostrarRegistros("");
    ...
    private void TablaDocentesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDocentesMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            Menu_pretamos_D2.txtCarnet.setText(cod);
            Menu_pretamos_D2.txtDocente.setText(valor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_docentes2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_docentes2().setVisible(true);
            }
        });
    }
