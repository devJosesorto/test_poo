...
public class ver_libros2 extends javax.swing.JFrame {
    ...
    private void TablaLibrosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaLibrosMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            Menu_pretamos_E2.txtCod_material.setText(cod);
            Menu_pretamos_E2.txtTitulo.setText(valor);
            Menu_pretamos_E2.txtisbn.setText(isbn);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_libros2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_libros2().setVisible(true);
            }
        });
    }
