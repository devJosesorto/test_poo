...
public class ver_docentes extends javax.swing.JFrame {
    ...
    private void TablaDocentesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDocentesMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            especie = TablaDocentes.getValueAt(fila, 5).toString();

   
            
            M_pretamos.txtCarnet.setText(cod);
            M_pretamos.txtDocente.setText(valor);
            M_pretamos.txtEspecie.setText(especie);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_docentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_docentes().setVisible(true);
            }
        });
    }
