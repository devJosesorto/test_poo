...
public class ver_estudiantes extends javax.swing.JFrame {

     Conexion con = new Conexion();
    Connection cnn = con.conexion();
    
    public ver_estudiantes() {
        initComponents();
        mostrarRegistros("");
    ...
    private void TablaEstudiantesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaEstudiantesMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            M_pretamos.txtEspecie.setText(grado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_estudiantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_estudiantes().setVisible(true);
            }
        });
    }
