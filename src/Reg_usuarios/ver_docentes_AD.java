...
public class ver_docentes_AD extends javax.swing.JFrame {

     Conexion con = new Conexion();
    Connection cnn = con.conexion();
    
    public ver_docentes_AD() {
        initComponents();
        mostrarRegistros("");
    ...
    private void TablaDocentesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDocentesMousePressed
       ...
       if (evt.getClickCount() == 2) {
            ...
            Formulario_Usuarios_nuevo.txtCarnet.setText(cod);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_docentes_AD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_docentes_AD().setVisible(true);
            }
        });
    }
