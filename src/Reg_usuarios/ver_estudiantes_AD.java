...
public class ver_estudiantes_AD extends javax.swing.JFrame {

     Conexion con = new Conexion();
    Connection cnn = con.conexion();
    
    public ver_estudiantes_AD() {
        initComponents();
        mostrarRegistros("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_estudiantes_AD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ver_estudiantes_AD().setVisible(true);
            }
        });
    }
