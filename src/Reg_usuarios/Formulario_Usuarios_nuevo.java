...
public class Formulario_Usuarios_nuevo extends javax.swing.JFrame {
    ...
    public Formulario_Usuarios_nuevo() {
        initComponents();
        ...
        txtUsuario.setDocument(new Validar_txt(txtUsuario,10));
        txtPsswd.setDocument(new Validar_txt(txtPsswd,50));
    ...
    private void initComponents() {
        ...
        btnbuscar_estudiante = new javax.swing.JButton();
        ...
        btnbuscar_estudiante.setBackground(new java.awt.Color(255, 255, 255));
        btnbuscar_estudiante.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnbuscar_estudiante.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes_bi/alumno.JPG"))); // NOI18N
        btnbuscar_estudiante.setToolTipText("BUSCAR ESTUDIANTE");
        btnbuscar_estudiante.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnbuscar_estudianteActionPerformed(evt);
            }
        });
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtCarnet, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            ...
                                            .addGap(18, 18, 18)
                                            .addComponent(btnbuscar_estudiante, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnBuscar_docente, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btnbuscar_estudiante, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(42, 42, 42)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (txtId.getText().equals("") || txtUsuario.getText().equals("") || txtPsswd.getText().equals("")|| txtCarnet.getText().equals("") || cbxTipo.getSelectedItem().equals("seleccionar:")) {
            JOptionPane.showMessageDialog(null, "FAVOR VALIDAR LOS CAMPOS");

        } else {
            try {

                PreparedStatement pst = cnn.prepareStatement("INSERT INTO usuarios (id,usuario,contrasenia,carnet,tipo_usuario) VALUES(?,?,?,?,?)");
                pst.setString(1, txtId.getText());
                pst.setString(2, txtUsuario.getText());
                pst.setString(3, txtPsswd.getText());
                pst.setString(4, txtCarnet.getText());
                pst.setString(5, cbxTipo.getSelectedItem().toString());
    ...
    private void EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarActionPerformed
        ...
        if (fila >= 0) {
            ...
            txtCarnet.setText(tabla_usuario.getValueAt(fila, 3).toString());
            cbxTipo.setSelectedItem(tabla_usuario.getValueAt(fila, 4).toString());
    ...
    private void btnBuscar_docenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscar_docenteActionPerformed
       ...
       ver_docentes_AD doc = new ver_docentes_AD();
        doc.setVisible(true);
    }//GEN-LAST:event_btnBuscar_docenteActionPerformed

    private void btnbuscar_estudianteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscar_estudianteActionPerformed
        // TODO add your handling code here:
        ver_estudiantes_AD alumn = new ver_estudiantes_AD();
        alumn.setVisible(true);
    }//GEN-LAST:event_btnbuscar_estudianteActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Formulario_Usuarios_nuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Formulario_Usuarios_nuevo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnbuscar_alumno1;
    private javax.swing.JButton btnbuscar_alumno2;
    private javax.swing.JButton btnbuscar_alumno3;
    private javax.swing.JButton btnbuscar_alumno4;
    private javax.swing.JButton btnbuscar_estudiante;
